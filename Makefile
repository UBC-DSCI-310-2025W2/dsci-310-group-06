...
EDA_FIGS := results/figures/01_ggpairs-plot.png \
...
EDA_TABLES := results/tables/01_summary-stats.csv

KNN_OUTS := results/figures/20_coarse-knn-k-sweep.png \
			results/figures/21_knn-confusion-matrix.png \
...
LOGREG_OUTS := results/figures/22_logreg-confusion-matrix.png \
...
XGB_OUTS := results/figures/23_xgboost-feature-importance.png \
			results/figures/24_xgboost-confusion-matrix.png \
...
FINAL_OUTS := results/figures/25_validation-metrics-comparison.png \
              results/figures/26_validation-confusion-matrices.png \
...
# Top Level Target
all: analysis/stroke_risk_prediction.pdf
