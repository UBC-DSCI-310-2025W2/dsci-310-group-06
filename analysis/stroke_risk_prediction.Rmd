...
stroke_summary_stats |>
  knitr::kable(caption = "Summary Statistics of Stroke Dataset")
```
...
age_bmi <- stroke |>
  ...
  plot_theme +
  scale_color_manual(
    values = alpha(c("No" = "#F8766D", "Yes" = "#00BFC4"), c(0.25, 1.0))
  )
...
residence_heartdisease <- stroke |>
  ...
  geom_jitter(width = 0.08, height = 0.08, alpha = 0.15, size = 0.8) +
  labs(
