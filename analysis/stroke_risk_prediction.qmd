...
We get a final score of 0.4691, which is not too good as the metric is
on a scale from \[0,1\]. From the confusion matrix, we can see that the
model is predicting a lot of True negatives.
