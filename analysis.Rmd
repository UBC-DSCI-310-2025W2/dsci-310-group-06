...
grid.arrange(
  ...
  ncol = 2,
  top = textGrob(
    "Figure 17. Stroke cases by average glucose level with hypertension and heart disease",
...
grid.arrange(
  ...
  ncol = 2,
  top = textGrob(
    "Figure 19. Percentage of stroke cases by residence type with heart disease and hypertension",
    gp = gpar(fontsize = 14, fontface = "bold")
  )
)
```
...
grid.arrange(
  ...
  ncol = 2,
  top = textGrob(
    "Figure 20. Percentage of stroke cases by marital status and work type",
    gp = gpar(fontsize = 14, fontface = "bold")
  )
)
```
