...
glucose_hypertension <- stroke %>%
  ...
  labs(
    ...
    y = "Hypertension",
    color = "Stroke",
    title = "Figure 17A. Stroke cases by average glucose level and hypertension"
  ) +
  plot_theme +
  scale_color_manual(
    values = alpha(c("No" = "#F8766D", "Yes" = "#00BFC4"), c(0.2, 1.0))
...
glucose_heartdisease <- stroke %>%
  ...
  labs(
    ...
    y = "Heart disease",
    color = "Stroke",
    title = "Figure 17B. Stroke cases by average glucose level and heart disease"
  ) +
  plot_theme +
  scale_color_manual(
    values = alpha(c("No" = "#F8766D", "Yes" = "#00BFC4"), c(0.2, 1.0))
...
residence_heartdisease <- stroke %>%
  ...
  labs(
    ...
    y = "Heart disease",
    color = "Stroke",
    title = "Figure 18A. Stroke cases by residence type and heart disease"
  ) +
  plot_theme +
  scale_color_manual(
    values = alpha(c("No" = "#F8766D", "Yes" = "#00BFC4"), c(0.2, 1.0))
...
residence_hypertension <- stroke %>%
  ...
  labs(
    ...
    y = "Hypertension",
    color = "Stroke",
    title = "Figure 18B. Stroke cases by residence type and hypertension"
  ) +
  plot_theme +
  scale_color_manual(
    values = alpha(c("No" = "#F8766D", "Yes" = "#00BFC4"), c(0.2, 1.0))
...
heartdisease_residence <- stroke %>%
  ...
  labs(
    ...
    y = "Percentage",
    fill = "Stroke",
    title = "Figure 19A. Percentage of stroke cases by residence type and heart disease"
  ) +
  plot_theme
...
hypertension_residence <- stroke %>%
  ...
  labs(
    ...
    y = "Percentage",
    fill = "Stroke",
    title = "Figure 19B. Percentage of stroke cases by residence type and hypertension"
  ) +
  plot_theme
...
ever_married_plot <- stroke %>%
  ...
  labs(
    ...
    y = "Percentage",
    fill = "Stroke",
    title = "Figure 20A. Percentage of stroke cases by marital status"
  ) +
  plot_theme
...
work_type_plot <- stroke %>%
  ...
  labs(
    ...
    y = "Percentage",
    fill = "Stroke",
    title = "Figure 20B. Percentage of stroke cases by work type"
  ) +
  plot_theme +
  theme(axis.text.x = element_text(angle = 20, hjust = 1))

grid.arrange(ever_married_plot, work_type_plot, ncol = 2)
```
